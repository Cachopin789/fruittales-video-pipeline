...
**Limitaciones:** solo funciona para el usuario indicado en `OWNER_USER_ID`, dentro de un servidor, y con el bot teniendo permiso de Administrador. Es seguro repetirlo: no duplica nombres existentes, reanuda una configuración interrumpida y renombra los nombres antiguos sin emoji. Para asignar automáticamente el rol `Miembro` a nuevas entradas, activa **Server Members Intent** en Discord Developer Portal.
